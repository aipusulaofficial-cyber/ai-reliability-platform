...
## Decision
The core domain is implemented as SLI/SLO evaluation, error budgets and burn-rate measurement. FastAPI exposes the domain contract and maps expected validation failures to HTTP 400. Kubernetes and Helm provide bounded resources, probes, non-root execution, horizontal scaling and disruption protection. Terraform manages the Kubernetes Deployment and Service as infrastructure-as-code.
